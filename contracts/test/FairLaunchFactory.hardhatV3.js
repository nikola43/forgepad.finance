...
describe("Fair Launch", async () => {
  before(async () => {
    ...
    await fairLaunch.setPlatformBuyFeePercent(3)
    await fairLaunch.setPlatformSellFeePercent(6)
  });
  ...
  describe("Functions", async () => {
    ...
    it("Buy Token", async () => {
      ...
      let eth_amount = ethers.utils.parseEther("1");
      ...
      // // console.log("User Token Balance: ", ethers.utils.formatEther(addr2TokenBalance));
      // // console.log("User ETH Balance: ", ethers.utils.formatEther(addr2EthBalance));
      // console.log("SELLING.....")
      // await newTokenContract.connect(addr2).approve(fairLaunch.address, ethers.constants.MaxUint256);
      // await fairLaunch.connect(addr2).sellTokens(newToken, addr2TokenBalance);
    });
