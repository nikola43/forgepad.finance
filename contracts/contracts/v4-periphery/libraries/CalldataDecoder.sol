...
library CalldataDecoder {
    ...
    function decodeModifyLiquidityParams(
    ...
    function decodeIncreaseLiquidityFromDeltasParams(
        bytes calldata params
    )
        internal
        pure
    ...
    function decodeMintFromDeltasParams(
        bytes calldata params
    )
        internal
        pure
    ...
    function decodeSwapExactInParams(
        bytes calldata params
    ) internal pure returns (IV4Router.ExactInputParams calldata swapParams) {
    ...
    function decodeSwapExactInSingleParams(
        bytes calldata params
    )
        internal
        pure
    ...
    function decodeSwapExactOutParams(
        bytes calldata params
    ) internal pure returns (IV4Router.ExactOutputParams calldata swapParams) {
    ...
    function decodeSwapExactOutSingleParams(
        bytes calldata params
    )
        internal
        pure
    ...
    function decodeCurrencyPairAndAddress(
        bytes calldata params
    )
        internal
        pure
    ...
    function decodeCurrencyAndAddress(
        bytes calldata params
    ) internal pure returns (Currency currency, address _address) {
        assembly ("memory-safe") {
            if lt(params.length, 0x40) {
                mstore(0, SLICE_ERROR_SELECTOR)
                revert(0x1c, 4)
    ...
    function decodeCurrencyAndUint256(
        bytes calldata params
    ...
    function decodeCurrencyUint256AndBool(
        bytes calldata params
    ) internal pure returns (Currency currency, uint256 amount, bool boolean) {
        assembly ("memory-safe") {
            if lt(params.length, 0x60) {
                mstore(0, SLICE_ERROR_SELECTOR)
                revert(0x1c, 4)
