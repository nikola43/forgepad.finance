...
library SafeCurrencyMetadata {
    ...
    function currencyDecimals(address currency) internal view returns (uint8) {
        ...
        (bool success, bytes memory data) = currency.staticcall(
    ...
    function callAndParseStringReturn(
        ...
        (bool success, bytes memory data) = currencyAddress.staticcall(
