export const isDevEnv = false // process.env.REACT_APP_ENV==="development"
...
export const API_ENDPOINT = isDevEnv ? `http://localhost:5001` : `https://api.forgepad.finance`
// export const FILE_ENDPOINT = `${API_ENDPOINT}/uploads` // `https://files.ethism.fun/`
export const FILE_ENDPOINT = isDevEnv ? `${API_ENDPOINT}/uploads` : `https://files.forgepad.finance`
