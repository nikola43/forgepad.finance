...
contract ForgepadAdvancedTest is Test {
    ...
    function test_PriceImpactCircuitBreaker() public {
        ...
        forgepad.swapExactETHForTokens{value: 5.5 ether}(t, 5.5 ether, 0);
    ...
    function test_MinimumLiquidityEnforced() public {
        ...
        forgepad.swapExactTokensForETH(t, tokenBalance / 10, 0);
        vm.stopPrank();
    ...
    function test_KValueNeverDecreases() public {
        ...
        if (bal1 > 0) {
            ...
            forgepad.swapExactTokensForETH(t, bal1 / 10, 0);
            vm.stopPrank();
