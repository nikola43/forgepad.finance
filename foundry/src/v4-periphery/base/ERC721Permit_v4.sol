...
abstract contract ERC721Permit_v4 is
    ERC721,
    IERC721Permit_v4,
    EIP712_v4,
    UnorderedNonce
{
    ...
    ) ERC721(name_, symbol_) EIP712_v4(name_) {}
    ...
    function permit(
        ...
        bytes32 digest = ERC721PermitHash.hashPermit(
            spender,
            tokenId,
            nonce,
            deadline
    ...
    function permitForAll(
        ...
        bytes32 digest = ERC721PermitHash.hashPermitForAll(
            operator,
            approved,
            nonce,
            deadline
