...
contract PositionDescriptor is IPositionDescriptor {
        ...
        return
            Descriptor.constructTokenURI(
                Descriptor.ConstructTokenURIParams({
                    ...
                    quoteCurrencySymbol: SafeCurrencyMetadata.currencySymbol(
                        quoteCurrency,
                        nativeCurrencyLabel()
                    ),
                    baseCurrencySymbol: SafeCurrencyMetadata.currencySymbol(
                        baseCurrency,
                        nativeCurrencyLabel()
                    ),
                    quoteCurrencyDecimals: SafeCurrencyMetadata
                        .currencyDecimals(quoteCurrency),
                    baseCurrencyDecimals: SafeCurrencyMetadata.currencyDecimals(
                        baseCurrency
                    ),
    ...
    function flipRatio(
        ...
        return
            currencyRatioPriority(currency0) > currencyRatioPriority(currency1);
    }
