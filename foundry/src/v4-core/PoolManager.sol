    ...
    Exttload
{
        ...
        returns (BalanceDelta swapDelta)
    {
        ...
        BeforeSwapDelta beforeSwapDelta;
        {
            ...
            (amountToSwap, beforeSwapDelta, lpFeeOverride) = key
                .hooks
                .beforeSwap(key, params, hookData);
    ...
    function _swap(
        ...
        if (amountToProtocol > 0)
            _updateProtocolFees(inputCurrency, amountToProtocol);
    ...
    function settleFor(
        address recipient
    ) external payable onlyWhenUnlocked returns (uint256) {
